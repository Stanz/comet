  ...
  return (
    <div className="text-center w-full mb-7 mt-12 mx-auto">
      <div className="flex items-center justify-center gap-[15px] mb-2.5 h-[50px]">
        <h1 className="text-[calc(1.375rem+1.5vw)] font-medium m-0 flex items-center leading-none text-white whitespace-nowrap">
          <img
      ...
      {subtitle && <p className="text-[1.1rem] text-gray-400 m-0">{subtitle}</p>}
